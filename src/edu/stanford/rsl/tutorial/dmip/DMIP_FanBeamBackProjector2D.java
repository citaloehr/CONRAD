...
public class DMIP_FanBeamBackProjector2D {
	...
	public void setSinogramParams(Grid2D sino, double focalLength, double maxRot)
	{
		...
		this.maxBeta = maxRot + 2.0*halfFanAngle; //TODO
	...
	public Grid2D backproject(Grid2D sino, int[] recoSize, double[] spacing)
	{
		...
		for(int p = 0; p < numProjs; p++)
		{
			...
			final SimpleVector dirDet = detBorder.getAbstractVector().multipliedBy(-1.0);//TODO
			...
			for(int x = 0; x < recoSize[0]; x++)
			{
				...
				float wx = (float) ( (x - recoSize[0]/2.0 + 0.5f) * spacing[0] ); //TODO
	...
	public static void main(String arg[])
	{
		...
		String filename = "/proj/i5dmip/si45babo/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/Sinogram0.tif";
